                ...
                <div class="row">
                        ...
                        >
                            <div class="card-header">
                                <span class="font-weight-bold"
                                    ><i class="fa fa-chart-bar"></i> Penjualan
                                    dalam 7 Hari</span
                                >
                            </div>
                            <div class="card-body">
                    ...
                    <div class="col-md-4">
                        ...
                        >
                            ...
                            <div class="card-body">
                                <strong>{{ count_sales_today }}</strong> Terjual
                                <hr />
                                <h5 class="fw-bold">
                        ...
                        >
                            <div class="card-header">
                                <span class="font-weight-bold"
                                    ><i class="fa fa-chart-bar"></i> Keuntungan
                                    Hari Ini</span
                                >
                            </div>
                            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        >
                            <div class="card-header">
                                <span class="font-weight-bold"
                                    ><i class="fa fa-chart-pie"></i> Produk
                                    Terlaris</span
                                >
                            </div>
                            <div class="card-body">
